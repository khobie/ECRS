                ...
                <tr key={r.id} className="border-b border-slate-50 last:border-0 hover:bg-slate-50">
                  ...
                  <td className="px-5 py-3">
                    <div className="flex items-center justify-end gap-1">
                      <Link to="/dashboard/investigation" className="grid h-8 w-8 place-items-center rounded-lg text-police-700 hover:bg-police-50" title="View case">
            ...
            {Array.from({ length: totalPages }).map((_, i) => (
              <button
                ...
                className={`h-8 w-8 rounded-lg text-sm font-medium ${
                  current === i + 1 ? "bg-police-700 text-white" : "text-slate-500 hover:bg-slate-100"
                }`}
              >
                {i + 1}
              </button>
